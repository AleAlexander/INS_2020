...
def getData():
    ...
    dataTrain, dataTest, labelTrain, labelTest = train_test_split(data, labels, test_size=0.2)
...
if __name__ == '__main__':
    ...
    model = createModel()
    history = model.fit(dataTrain, labelTrain, epochs=10, batch_size=100,
                        validation_data=(dataTest, labelTest), 
                        callbacks=[MyCallback((dataTest, labelTest))]
                        )
